...
export const en = {
  ...
  'nav.profile': 'Profile',
  'nav.me': 'Profile',
  'me.signedOutTitle': 'Sign in for your own page',
  'me.signedOutBody': 'The photographs you post from places all live here.',
  'profile.changeAvatar': 'Change your profile photo',
  'profile.posts': 'Posts',
  'profile.reviews': 'Reviews',
  'profile.placesVisited': 'Places',
  'profile.viewGrid': 'Grid view',
  'profile.viewFeed': 'Feed view',
  'checkin.compose': 'Post a photo',
  'checkin.composeTitle': 'Post a photo from somewhere',
  'checkin.where': 'Where',
  'checkin.wherePlaceholder': 'Search saved and nearby',
  'checkin.noPlaces': 'Nothing to choose from yet. Save a place, or turn on location.',
  'checkin.photos': 'Photos (up to {max})',
  'checkin.caption': 'Caption',
  'checkin.captionPlaceholder': 'How was it?',
  'checkin.post': 'Post',
  'checkin.needPlace': 'Pick a place first.',
  'checkin.needPhoto': 'Add at least one photo.',
  'checkin.delete': 'Delete post',
  'checkin.openAt': 'Post at {place}',
  'checkin.photoAt': 'A photo taken at {place}',
  'checkin.emptyTitle': 'No posts yet',
  'checkin.emptyOwnTitle': 'Your page is empty',
  'checkin.emptyOwnBody': 'Post the first photograph from somewhere you just went.',
  ...
  'taxonomy.icon': 'Icon',
  'taxonomy.editStyle': 'Change the icon and colour of {name}',
  'taxonomy.preview': 'Preview',
  'taxonomy.customColour': 'Custom',
