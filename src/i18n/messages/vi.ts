...
export const vi: Messages = {
  ...
  'nav.profile': 'Cá nhân',
  'nav.me': 'Cá nhân',
  'me.signedOutTitle': 'Đăng nhập để có trang của bạn',
  'me.signedOutBody': 'Ảnh bạn đăng ở mỗi địa điểm sẽ nằm hết ở đây.',
  'profile.changeAvatar': 'Đổi ảnh đại diện',
  'profile.posts': 'Bài đăng',
  'profile.reviews': 'Đánh giá',
  'profile.placesVisited': 'Nơi đã tới',
  'profile.viewGrid': 'Xem dạng lưới',
  'profile.viewFeed': 'Xem dạng dòng',
  'checkin.compose': 'Đăng ảnh',
  'checkin.composeTitle': 'Đăng ảnh từ một nơi',
  'checkin.where': 'Ở đâu',
  'checkin.wherePlaceholder': 'Tìm trong nơi đã lưu và quanh đây',
  'checkin.noPlaces': 'Chưa có nơi nào để chọn. Lưu một địa điểm hoặc bật vị trí.',
  'checkin.photos': 'Ảnh (tối đa {max})',
  'checkin.caption': 'Chú thích',
  'checkin.captionPlaceholder': 'Hôm đó thế nào?',
  'checkin.post': 'Đăng',
  'checkin.needPlace': 'Chọn một địa điểm trước.',
  'checkin.needPhoto': 'Thêm ít nhất một tấm ảnh.',
  'checkin.delete': 'Xoá bài đăng',
  'checkin.openAt': 'Bài đăng ở {place}',
  'checkin.photoAt': 'Ảnh chụp ở {place}',
  'checkin.emptyTitle': 'Chưa có bài đăng nào',
  'checkin.emptyOwnTitle': 'Trang của bạn còn trống',
  'checkin.emptyOwnBody': 'Đăng tấm ảnh đầu tiên từ một nơi bạn vừa tới.',
  ...
  'overview.trends': 'Xu hướng',
  'overview.days': '{count} ngày',
  'overview.growth': 'Lượng mới',
  'overview.growthHint': 'Mỗi ngày nền tảng có thêm những gì',
  'overview.decisions': 'Quyết định duyệt',
  'overview.decisionsHint': 'Địa điểm, chỉnh sửa và doanh nghiệp được quyết mỗi ngày',
  'overview.catalogue': 'Kho địa điểm',
  'overview.catalogueHint': 'Toàn bộ địa điểm theo trạng thái, không tính đã xoá',
  'overview.ratings': 'Phân bố sao',
  'overview.ratingsHint': 'Đánh giá đã đăng theo số sao',
  'overview.noReviews': 'Chưa có đánh giá nào được đăng.',
  ...
  'overview.saveCount': '{count} lượt lưu',
  'overview.byCategory': 'Đã đăng theo danh mục',
  'overview.byCategoryHint': 'Chỉ tính danh mục cấp một',
  'overview.demand': 'Tìm mà không ra',
  'overview.demandHint': 'Những từ khoá không trả về kết quả nào trong 30 ngày qua — đây là thứ nên thêm tiếp.',
  'overview.demandShare': '{percent}%',
  'overview.demandNone': 'Mọi lượt tìm trong khoảng này đều ra kết quả.',
  'overview.seeAllDemand': 'Xem toàn bộ nhu cầu tìm kiếm',
  'chart.totalOverDays': '{count} trong {days} ngày',
  'chart.approved': 'Đã duyệt',
  'chart.rejected': 'Từ chối',
  ...
  'taxonomy.icon': 'Biểu tượng',
  'taxonomy.editStyle': 'Đổi biểu tượng và màu của {name}',
  'taxonomy.preview': 'Xem trước',
  'taxonomy.customColour': 'Màu tự chọn',
  'taxonomy.colour': 'Màu',
